import '../screens/singin';

// local imgs
const Onboarding = require("../assets/imgs/bg1.png");
const Logo = require("../assets/imgs/Logo.png");
const LogoOnboarding = require("../assets/imgs/logo1.png");
const ProfileBackground = require("../assets/imgs/profile-screen-bg.png");
const RegisterBackground = require("../assets/imgs/register-bg.png");
const SingInBackground = require("../assets/imgs/SingIn-bg.png");
const Pro = require("../assets/imgs/getPro-bg.png");
const ArgonLogo = require("../assets/imgs/vertical.png");
const iOSLogo = require("../assets/imgs/ios.png");
const androidLogo = require("../assets/imgs/android.png");
const Ericsson = require("../assets/imgs/Ericsson.png");

// internet imgs

const ProfilePicture = global.profile
